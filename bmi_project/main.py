...
def bmi_range(bmi_val):
    if bmi_val <= 18.4:
        return 1                                    #["Underweight","MalnutritionRisk"]
    elif bmi_val >=18.5 and bmi_val <= 24.9:
        return 2                                    #["NormalWeight","LowRisk"]
    elif bmi_val >=25 and bmi_val <= 29.9:
        return 3                                    #["OverWeight","EnhancedRisk"]
    elif bmi_val >=30 and bmi_val <= 34.9:
        return 4                                    #["ModeratelyObese","MediumRisk"]
    elif bmi_val >=35 and bmi_val <= 39.9:
        return 5                                    #["SeverelyObese","HighRisk"]
    else:
        return 6                                    #["VerySeverelyObese","VeryHighRisk"]
